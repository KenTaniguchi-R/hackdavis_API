...
def save_default(sender, **kwargs):
    data = [
        ...
        {
            'post': "20年以上にわたって、私は企業社会の刺激的なリズムに浸ってきました。戦略的なプランニングやリーダーシップの課題という容赦ない波を受け入れ、その一つひとつが、私を今日のような献身的なプロフェッショナルへと形成していったのです。成功のスリル、挫折の辛さ、学んだ貴重な教訓、そのすべてが私の旅の足がかりとなりました。",
            'comments': []
        },
        {
